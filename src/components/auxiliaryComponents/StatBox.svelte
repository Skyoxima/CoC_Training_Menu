...
<style>
  ...
  .stat .top-filter {
    ...
    background: rgba(var(--pure-white-rgb), 0.15);
  }

  .stat-header {
    position: relative;     /* without this the pseudoelement is coming on top, without this position is not found on the element... */
